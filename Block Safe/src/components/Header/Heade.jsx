...
export default function Header() {
  ...
  return (
    <>
      <header className="shadow sticky z-50 top-0 bg-slate-800">
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div className="text-white  bg-slate-800 hover:bg-slate-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg  px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">
